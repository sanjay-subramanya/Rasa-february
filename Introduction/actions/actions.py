...
# class ActionSayPlace(Action):
    ...
    # def run(self, dispatcher: CollectingDispatcher,
        ...
        # if place == None:
            # dispatcher.utter_message(text=f"What are your favourite places to visit there? !Q@W#D My favourite places are the beaches and museums")
        # else:
...
# class ActionSayBye(Action):
     ...
     # def run(self, dispatcher: CollectingDispatcher,
        ...
        # dispatcher.utter_message(text=f"It was great talking to you. Thank you for your time, goodbye! !Q@W#D .")
        # return [AllSlotsReset()]
